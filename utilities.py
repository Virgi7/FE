...
def read_our_CSV(df):
    ...
    df_ptf = df_ptf.loc[:, ['ADSGn.DE', 'ALVG.DE', 'MUVGn.DE',
                            'OREP.PA']]  # we select only the 4 columns corresponding to Adidas, Allianz, Munich RE and l'Oreal
    df_den = df[
             825:1593]  # we selected 3y from one day before 20-03-2019 (19-03-2019) up one day before the last date of df_ptf (21-03-2016)
